...
public class CreateTimerFeature extends CreateElementFeature {
    ...
    public boolean canCreate(ICreateContext context) {
        ...
        return parentObject instanceof ITimed && parentObject.getChildrenRecursive(Timer.class).isEmpty() && !(parentObject.getParentContainer() instanceof IBoundaryEventContainer);
    }
}
